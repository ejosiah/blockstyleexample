<?php
/**
 * Block Style Example: Block Patterns
 *
 ...
 * @return void
 */
function blockstyleexample_register_block_patterns() {
	$block_pattern_categories = array(
		...
		'blockstyleexample_pages' => array( 'label' => __( 'Pages', 'twentytwentytwo' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'blockstyleexample_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'blockstyleexample_block_patterns', $block_patterns );
...
add_action( 'init', 'blockstyleexample_register_block_patterns', 9 );
