...
Block Style Example WordPress Theme, 2021-2025 WordPress.org and contributors.
Block Style Example is distributed under the terms of the GNU GPL.
...
Includes modified versions created specifically for Block Style Example.
...
Modified versions of the above images, as well as additional "flight path" illustrations were created specifically for Block Style Example. CC0.
